...
public class yogulJobTest {

	private Logger logger = LoggerFactory.getLogger(yogulJobTest.class);
	
	@Autowired // 타입으로 찾아냄 -> @Resoucer 사용하고 싶으면
	...
	public void testYogultJob() throws Exception {
		...
		/***When***/
		JobExecution jobExcecution = jobLauncher.launchJob(new JobParameters(map));
		/***Then***/
		assertEquals(ExitStatus.COMPLETED,jobExcecution.getExitStatus());
	}
